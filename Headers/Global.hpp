#pragma once
constexpr unsigned char ghostnum = 32;//supposed to be 32
constexpr unsigned char pacnum = 16;
...
constexpr unsigned char GHOST_ESCAPE_SPEED = 16;
...
constexpr unsigned char GHOST_SPEED = 8;
constexpr unsigned char MAP_HEIGHT = 42;
constexpr unsigned char MAP_WIDTH = 98;//ONLY the effective blocks
...
constexpr unsigned char PACMAN_SPEED = 8;
...
constexpr unsigned short FRAME_DURATION = 65535;
